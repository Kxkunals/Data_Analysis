...
![Downloads](https://img.shields.io/badge/dynamic/json?url=https://pypistats.org/api/packages/Efficient/recent&label=Downloads&query=%24.data.last_month&suffix=%2Fmonth&color=orange)
...
```python
from Efficient import run_pipeline_in_notebook
